// app/liquidstake/StakeComponent.js
'use client';
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-md space-y-6 w-full max-w-lg">
      ...
      <div className="flex space-x-4">
        <button className="flex-1 py-3 bg-purple-100 text-purple-600 rounded-md font-medium hover:bg-purple-200">
          UNLOCK TOKEN
        </button>
        <button className="flex-1 py-3 bg-purple-600 text-white rounded-md font-medium hover:bg-purple-700">
          STAKE NOW
        </button>
      </div>
